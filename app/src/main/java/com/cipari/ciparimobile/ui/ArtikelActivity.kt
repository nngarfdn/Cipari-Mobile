...
import com.cipari.ciparimobile.databinding.ActivityArtikelBinding
...
class ArtikelActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            listArticle.add(
                Artikel("PAKAN SUPLEMEN TERNAK BERUPA MINERAL BLOK UNTUK SAPI PERAH",
            ...
            listArticle.add(
                Artikel("RUMPUT VARIETAS \"GAMA UMAMI\" SEBAGAI UPAYA PENINGKATAN KETERSEDIAAN HIJAUAN DI KELURAHAN CIPARI",
            ...
            listArticle.add(
                Artikel("PEMBUATAN PUPUK KOMPOS DARI KOTORAN SAPI UNTUK MENINGKATKAN UMKM",
            ...
            listArticle.add(
                Artikel("PENTINGNYA SANITASI PASCA PMK (PENYAKIT MULUT DAN KUKU) "+
